...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero Banner */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/90 via-primary to-accent/80 text-white">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-32 h-32 rounded-full bg-white/20 blur-2xl" />
          <div className="absolute bottom-10 right-20 w-48 h-48 rounded-full bg-secondary/30 blur-3xl" />
          <div className="absolute top-1/2 left-1/3 w-24 h-24 rounded-full bg-accent/40 blur-2xl" />
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-sm opacity-70 max-w-md">
                함께 게임하고, 함께 웃고, 함께 성장하는 보드게임 동아리
              </p>
            </div>
            <div className="shrink-0">
              <img
                src="/meeplez.jpg"
                alt="미플즈"
                className="w-40 h-40 md:w-52 md:h-52 rounded-2xl object-cover shadow-2xl ring-4 ring-white/20"
              />
            </div>
          </div>
        </div>
