...
export default function HomeV4() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-10">
      {/* No banner - just clean header */}
      <header className="flex items-center gap-3 pb-6 border-b border-gray-200">
        <img src="/meeplez.jpg" alt="미플즈" className="w-12 h-12 rounded-xl object-cover shadow" />
        <div>
          <h1 className="text-xl font-bold text-primary">미플즈</h1>
          <p className="text-xs text-gray-400">보드게임을 사랑하는 사람들의 모임</p>
        </div>
      </header>
