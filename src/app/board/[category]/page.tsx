          ...
          {currentPosts.map((post) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {isNew(post) && (
                  <span className="text-[10px] font-bold text-white bg-primary rounded-full px-1.5 py-0.5 leading-none">NEW</span>
                )}
                </div>
                ...
                <tr key={post.id} className="border-t border-gray-50 dark:border-dark-border/50 hover:bg-cream/40 dark:hover:bg-dark-hover transition-colors">
                  ...
                  <td className="py-3.5 px-4">
                    ...
                    >
                      ...
                      {isNew(post) && <span className="inline-flex items-center text-[10px] font-bold text-white bg-primary rounded-full px-1.5 py-0.5 ml-1.5 leading-none">NEW</span>}
                    </Link>
                  </td>
